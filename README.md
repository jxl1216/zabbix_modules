...
2. 下载最新版本的 `HostBatchClone_vX.X.tar.gz` 文件
3. 解压并部署：

```bash
# Zabbix 6.0 / 7.0
tar -xzvf HostBatchClone_vX.X.tar.gz -C /usr/share/zabbix/modules/

# Zabbix 7.4 / 8.0
tar -xzvf HostBatchClone_vX.X.tar.gz -C /usr/share/zabbix/ui/modules/
```
